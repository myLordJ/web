      ...
      .header__block
        .header__middle
          .header__banner.banner
            .icon.fa.fa-mobile-phone.fa-2x
            p.banner__text
              a(href="https://play.google.com/store/apps/details?id=com.clapps.radioalacalle&hl=en", target="_blank") Bájate la App de la Radio
